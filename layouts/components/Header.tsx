            ...
            <div className={`w-full`}>
                <div
                    className={`container mx-auto ${
                        fixedOnMbile
                            ? 'fixed top-0 left-0 right-0 h-14 z-[1] bg-white shadow-sm'
                            : ''
                    }`}>
                    <div className='flex justify-between items-center h-14 md:h-[90px] px-2 xl:px-10 lg:px-2'>
                        {/* logo & nav */}
                        <div className='flex justify-start items-center lg:gap-5 xl:gap-10'>
                            ...
                            {/* navbar */}
                            <div className='hidden md:ml-3 xl:ml-0 lg:flex gap-2 xl:gap-3'>
                                <Link
                                    href={'/promotion'}
                                    className={`text-[18px] font-medium font-montserrat lg:px-2 xl:px-4 hover:drop-shadow-md h-12  
