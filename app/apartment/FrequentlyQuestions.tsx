...
export const tabContents: ContentWithSubContent[] = [
    {
        ...
        showContent: [
            'Just fill in the registration form, our team will immediately contact you within 1 x 24 working days regarding the contract, unit standardization, unit cleaning and unit arrangement so that it meets unit photo standards, unit photography, pricing, until your property is ready to be marketed on SMART REAL and distributed to several other leading online channels! All this in just a few weeks! Dont forget, if your unit meets our standards, it can speed up the process of marketing your property on our website and other websites. Register now at: www.SMART REAL.com/tpm',
            'Im well! Apartment management by SMART REAL can carry out exclusive marketing for Fully Furnish and Unfurnish (Empty) Apartments.',
            'Pengelolaan Apartemen oleh SMART REAL dapat membantu pemasaran unit anda di area Jabodetabek, Bandung, Surabaya, Makassar, Semarang, dan Jogjakarta. Apabila anda memiliki unit dengan quantity yang banyak, anda dapat menginformasikan kepada tim kami untuk pembahasan lebih lanjut.',
    ...
    {
        title: 'Apartment Management Services by SMART REAL',
        content: [
            {
                id: 5,
                text: 'What does Apartment Management by SMART REAL do for Property Owners?'
            },
            {
                id: 6,
        ...
        showContent: [
            ...
            'We will market your unit on our website, namely www.SMART REAL.com, as well as other online and offline sites. We have a Channel Manager so that marketing can be done on several online channels and there are no additional costs for this marketing facility.',
    ...
    },
    {
        ...
        content: [
            ...
            {
                id: 11,
                text: 'What are the steps to register with Apartment Management by SMART REAL until my unit is ready to be marketed?'
            },
            { id: 12, text: 'How long does the process take?' }
        ],
        showContent: [
            'The cooperation contract between SMART REAL and the owner is exclusive. We will carry out marketing to other channels, so that the owner no longer needs to continue marketing. We will re-photograph your unit, and re-check your unit so that it complies with the standards set by SMART REAL.',
            'The minimum cooperation contract with SMART REAL is only 12 months.',
            'SMART REAL has a standardization reference for units. This standardization is determined for marketing which is not only on a daily basis, but also on a monthly and annual basis. Standardization is required in terms of electronic goods, the condition of the unit (structurally) in a clean and good condition, cooking equipment, eating equipment, cleaning equipment.',
            'Contract Signing. Submission of Documents & Handover of Keys and Unit Access. Unit Standardization. Unit Cleaning. otoshoot Unit. Content Writing. Live on www.SMART REAL.com and other channels',
    ...
    },
    {
        ...
        content: [
            {
                id: 13,
                text: 'How do guests interact with Apartment Management by SMART REAL?'
            },
    ...
    },
    {
        ...
        content: [
            ...
            { id: 21, text: 'How is profit sharing implemented with SMART REAL?' },
        ...
        showContent: [
            'Registration of your unit at SMART REAL will be subject to a 1 x registration fee as long as you join Apartment Management by SMART REAL',
            'By paying the registration fee, your unit will get the benefits below:',
            'We implement a sharing commission system (profit sharing), there are no fixed fees that you have to pay to SMART REAL every month, so the commission we get depends on the transaction on the rental value that occurs. The greater the rental value, of course the greater the commission we get, and vice versa.',
    ...
    },
    {
        ...
        showContent: [
            'Apartment management by SMART REAL uses digital keys with a special code that will be issued per booking. The key is provided by us and is lent as long as your unit is still part of Apartment Management by SMART REAL. Codes will also be given to cleaning staff when they carry out cleaning in units with different formats, so that in this case tracking in and out of the unit can be tracked and unit security can be maintained.'
        ]
    },
    {
        ...
        showContent: [
            'No! The advantage of Apartment Management by SMART REAL is daily, monthly and annual rental. We will market your unit optimally, so that you as the Unit Owner get wider potential by opening daily, monthly and yearly rentals. For empty apartments, we will market them with a minimum rental of 3 months to yearly.If special conditions occur in the Owners Apartment building which cannot be rented out on a daily basis then we will refer to the provisions of each regulation in that Apartment.',
            'You can make reservations for your unit via the Liopartner application which is provided for unit owners who have joined Apartment Management by SMART REAL. As long as your unit is available, you can make the reservation and only pay the Cleaning Fee. Cleaning Fee is applied per booking not per day.',
