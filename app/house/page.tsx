    ...
    <div className="product_resgister">
      ...
      <div className="product_menu">
        <div className="product_menu_btn">
          <div className="container_menu">
            <div className="content_trusted">Trusted Real Estate Partner!</div>
            <h1 className='text_leading'>
              Leading in its field, Home Marketing by Travelio provides a wide marketing reach by combining Online Real Time
              Availability and Offline Networks. Get transparency and ease in monitoring your home rental through the
              LioPartner Application.</h1>
          </div>
            ...
            <SwiperSlide>
              <div className="product_color">
                <p className="professional">
                  ...
                  <span className="span">
                    Your unit will be photographed by our team of professional photographers to capture the best aspects of your
                    unit.
                  </span>
                </p>
            ...
            <SwiperSlide>
              <div className="product_color">
                <p className="professional">
                  ...
                  <span className="span">
                    Content is the salesman in the online world. Our content writers will describe each unit uniquely highlighting
                    the best aspects.
                  </span>
                </p>
            ...
            <SwiperSlide>
              <div className="product_color">
                <p className="professional">
                  ...
                  <span className="span">
                    ................. is the number 1 and largest site for residential rentals. Serving tens of thousands of
                    rentals every month.
                  </span>
                </p>
            ...
            <SwiperSlide>
              <div className="product_color">
                <p className="professional">
                  ...
                  <span className="span">Marketing through leading property sites in Indonesia.</span>
                </p>
            ...
            <SwiperSlide>
              <div className="product_color">
                <p className="professional">
                  ...
                  <span className="span">
                    ................. has the first page ranking in search engines mostly for apartment rental keywords.
                  </span>
                </p>
            ...
            <SwiperSlide>
              <div className="product_color">
                <p className="professional">
                  ...
                  <span className="span">
                    ................... has been dedicated to helping hundreds of our corporate partners in providing
                    accommodation for expatriate and intercity workers.
                  </span>
                </p>
            ...
            <SwiperSlide>
              <div className="product_color">
                <p className="professional">
                  ...
                  <span className="span">
                    Agent Partners are not our competitors, but partners. We collaborate with property agents throughout
                    Indonesia.
                  </span>
                </p>
      ...
      <div className="content_api">
        <div className="text-api">
          Servis Pemasaran Rumah oleh TO BE REAL
        </div>
