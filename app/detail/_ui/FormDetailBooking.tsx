...
const FormDetailBooking = () => {
    ...
    return (
        <div className={`${inter.className} w-full ${
            ...
            <p className='py-[2px] p-3 xl:px-4 xl:text-xl leading-5 xl:leading-6 font-bold tracking-wide border-b-[2px] border-[#e3e3e3] h-[50px] xl:h-[60px] 
            ...
            <div className='pt-3 px-2 xl:px-[22px]'>
                {!isShowInformation ?<>
                    <div className='max-w-[480px] lg:max-w-auto lg:w-full h-[30px] mx-auto flex item-center border border-[#d8d8d8]'>
                        <span className={`w-full text-center font-medium cursor-pointer hover:shadow-md transition duration-200 select-none ${
                    ...
                    <div className='pt-5 max-w-[480px] lg:max-w-auto mx-auto h-[355px] lg:h-[300px] xl:h-[355px]'>
                        ...
                        {currentFil === 'monthly' && <FormMonth onClick={handleShowInformation}/>}
                        {currentFil === 'annual' && <FormAnnual onClick={handleShowInformation}/>}
                    </div>
                </>:
